...
Known issue: When changing the test note the period and other data
presented on the top of the window are the previous note's!  If you
absolutely need to know the values for the current test note, exit the
test note selection and enter it again to view the data for the
current test note.
...
1. adjust Result buffer length
2. offset Source A wave data
3. mix Source A and Source B
4. adjust amplitude
5. recalculate octave number
...
| octave | max. buffer length | in hexadecimal |
|--------+--------------------+----------------|
|      / |                 <> |             <> |
|      7 |                  2 |            0x2 |
|      6 |                  5 |            0x5 |
